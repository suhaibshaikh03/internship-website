...
const testimonials: FloatingTestimonial[] = [
  {
    ...
    variant: "compact",
    className: "left-[11%] top-[24%] w-[21vw] max-w-[270px]",
  ...
  },
  {
    ...
    role: "Edversity's student",
    variant: "wide",
    className: "left-[16%] top-[45%] w-[30vw] max-w-[410px]",
  ...
  },
  {
    ...
    role: "Edversity's student",
    variant: "wide",
    className: "right-[9%] top-[24%] w-[30vw] max-w-[410px]",
  ...
  },
  {
    ...
    variant: "compact",
    className: "right-[20%] top-[48%] w-[21vw] max-w-[270px]",
  ...
  },
  {
    ...
    role: "Gen AI Student",
    variant: "wide",
    className: "right-[9%] bottom-[5%] w-[30vw] max-w-[410px]",
